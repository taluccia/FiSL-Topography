...
```{r}
ggplot() +  
  geom_sf(data=pt_shield, color = "red") +
  geom_sf(data=pt_plains, color = "blue") +
  coord_sf() +
...
```{r}
ggplot() +  
  geom_sf(data=pt_shield, aes(colour=burn_year)) +
  geom_sf(data=pt_plains, aes(colour=burn_year)) +
  coord_sf() +
  theme(legend.position="bottom")
